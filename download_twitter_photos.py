...
def download_new_images(media_urls, num_tweets, output_folder, list_of_downloaded_images, bucket, download_lambda_name):
  downloads = []
  datetime_stamp = get_datetime_no_spaces()
  if media_urls:
    for media_url in media_urls:
      ...
      if image_is_new(file_name=file_name, list_of_downloaded_images=list_of_downloaded_images):
        ...
        grouped_by_date_download_path = os.path.join(output_folder,datetime_stamp,file_name)
        #download_path = output_folder + file_name
        
        tell_lambda_to_download_image(media_url=media_url, download_path=grouped_by_date_download_path, bucket=bucket, download_lambda_name=download_lambda_name)
        msg = {
          "bucket": bucket,
          "output_folder": output_folder,
          "file_name": file_name,
          "download_path": grouped_by_date_download_path,
